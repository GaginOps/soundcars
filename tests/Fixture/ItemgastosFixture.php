 ...
 *
 */
class ItemgastosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'itg' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'itg' => 'Lorem ipsum dolor sit amet',
            'created' => 1,
            'modified' => 1
        ],
    ];
